...
namespace LibraryManagementSystem
{
    ...
    {
        // Fields for database connection and ST_ADINTERFACE
        ...
        // Constructor for the StudentNewAcc form
        public StudentNewAcc()
        {
            InitializeComponent();
            InitializeDatabaseConnection();

            // Initialize the ST_ADINTERFACE
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                // Add the student if the validation passes
        ...
        // Event handler for textbox text changed
