...
{
    // Partial class for the BB_CAS form
    public partial class BB_CAS : Form
    {
        ...
        // Constructor for the BB_CAS form
        public BB_CAS()
        {
            InitializeComponent();
        ...
        // Event handler when the BB_CAS form loads
        private void BB_CAS_Load(object sender, EventArgs e)
        {
        ...
        private void LoadDataGridView()
        {
            ...
            {
                fromDatabase.Open();
                // SQL query to select all data from the 'cas_borrowed_books' table
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BB_BOOKS_LIST_ADMIN BB_CAS = new BB_BOOKS_LIST_ADMIN();
            BB_CAS.Show();
            this.Close();
        }
    }
