...
{
    // Partial class for the BB_CTE form
    public partial class BB_CTE : Form
    {
        ...
        // Constructor for the BB_CTE form
        public BB_CTE()
        {
            InitializeComponent();
        ...
        // Event handler when the BB_CTE form loads
        private void BB_CTE_Load(object sender, EventArgs e)
        {
        ...
        private void LoadDataGridView()
        {
            ...
            {
                fromDatabase.Open();
                // SQL query to select all data from the 'cte_borrowed_books' table
        ...
        {
            string query = "SELECT * FROM librarymanagementsystem.cte_borrowed_books";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BB_BOOKS_LIST_ADMIN BB_CTE = new BB_BOOKS_LIST_ADMIN();
            BB_CTE.Show();
            this.Close();
        }
    }
