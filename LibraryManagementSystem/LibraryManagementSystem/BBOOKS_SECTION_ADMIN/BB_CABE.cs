...
{
    // Partial class for the BB_CABE form
    public partial class BB_CABE : Form
    {
        ...
        // Constructor for the BB_CABE form
        public BB_CABE()
        {
            InitializeComponent();
        ...
        // Event handler when the BB_CABE form loads
        private void BB_CABE_Load(object sender, EventArgs e)
        {
        ...
        private void LoadDataGridView()
        {
            ...
            {
                fromDatabase.Open();
                // SQL query to select all data from the 'cabe_borrowed_books' table
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BB_BOOKS_LIST_ADMIN BB_CABE = new BB_BOOKS_LIST_ADMIN();
            BB_CABE.Show();
            this.Close();
        }
    }
