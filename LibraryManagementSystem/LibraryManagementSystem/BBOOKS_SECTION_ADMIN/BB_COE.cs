...
{
    // Partial class for the BB_COE form
    public partial class BB_COE : Form
    {
        ...
        // Constructor for the BB_COE form
        public BB_COE()
        {
            InitializeComponent();
        ...
        // Event handler when the BB_COE form loads
        private void BB_COE_Load(object sender, EventArgs e)
        {
        ...
        private void LoadDataGridView()
        {
            ...
            {
                fromDatabase.Open();
                // SQL query to select all data from the 'coe_borrowed_books' table
        ...
        {
            string query = "SELECT * FROM librarymanagementsystem.coe_borrowed_books";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BB_BOOKS_LIST_ADMIN BB_COE = new BB_BOOKS_LIST_ADMIN();
            BB_COE.Show();
            this.Close();
        }
    }
