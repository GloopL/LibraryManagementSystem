...
{
    public partial class ST_COE_BOOKS : Form
    {
        ...
        private void ST_COE_BOOKS_Load(object sender, EventArgs e)
        {
        ...
        {
            STBOOK ST_COE_BOOKS = new STBOOK();
            ST_COE_BOOKS.Show();
            this.Close();
        }
        ...
        // Text changed event for the search textbox
