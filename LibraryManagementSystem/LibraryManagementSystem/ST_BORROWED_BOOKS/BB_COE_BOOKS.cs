...
{
    public partial class BB_COE_BOOKS : Form
    {
        ...
        private void BB_COE_BOOKS_Load(object sender, EventArgs e)
        {
        ...
        private void BorrowBookFromLibrary(string srcode, string bookId, string bookName)
        {
            try
            {
                ...
                string checkAvailabilityQuery = "SELECT Quantity FROM librarymanagementsystem.coe_book WHERE Book_ID = @bookId";
                    ...
                    if (result != null && Convert.ToInt32(result) > 0)
                    {
                        ...
                        using (MySqlCommand updateQuantityCommand = new MySqlCommand(updateQuantityQuery, fromDatabase))
                        {
                            ...
                            if (rowsAffected > 0)
                            {
                                ...
                                string insertBorrowedBookQuery = "INSERT INTO librarymanagementsystem.coe_borrowed_books (Student_ID, Book_ID, Book_Name, Borrowed_Date) " +
        ...
        private int GetNumberOfBorrowedBooks(string studentId)
        {
            ...
            string query = "SELECT COUNT(*) FROM librarymanagementsystem.coe_borrowed_books WHERE Student_ID = @studentId";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BB_BOOKS_LIST BB_COE_BOOKS = new BB_BOOKS_LIST();
            BB_COE_BOOKS.Show();
            this.Close();
        }
    }
