...
namespace LibraryManagementSystem
{
    ...
    {
        // Constructor for the Student1 form
        public Student1()
        {
            InitializeComponent();
        }

        // Load event for the Student1 form
        private void Form3_Load(object sender, EventArgs e)
        {
            // You can add any additional initialization code here if needed
        }

        // Button click event to navigate back to the Choices form
        ...
        // LinkLabel click event to open the StudentNewAcc form
        ...
        // Button click event for student login
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // Open the StudentInterface form upon successful login
